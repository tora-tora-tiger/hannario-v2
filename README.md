...
DISCORD_NON_EXPLICIT_REPLY_REPEATED_CONTENT_LIMIT=1
...
- Repeated identical ordinary messages are limited by
  `DISCORD_NON_EXPLICIT_REPLY_REPEATED_CONTENT_LIMIT` for both random
  participation and active follow-up replies. Explicit mentions, replies, and
  wake words still work.
